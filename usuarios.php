            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th>Email</th>
                  <th>Acciones
                    <a href="panel.php?modulo=crearUsuario"><i style="margin-left: 5px" class="fas fa-plus text-success"></i></a>
                  </th>
                </tr>
                </thead>
                <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="panel.php?modulo=editarUsuario&id=<?php echo $row['id']?>" style="margin-right: 10px" class="text-primary"><i class="fas fa-edit"></i></a>
